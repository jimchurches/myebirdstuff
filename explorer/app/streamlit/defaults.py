...
MAP_MARKER_COLOUR_SCHEME_1 = MapMarkerColourScheme(
    ...
    all_locations=MapMarkerAllLocationsStyle(
        fill_hex="#D3D3D3",
        edge_hex="#008000",
        circle_radius_px=MAP_CIRCLE_MARKER_RADIUS_PX,
    ...
    species_locations=MapMarkerSpeciesLocationsStyle(
        fill_hex="#FF0000",
        edge_hex="#800080",
        map_lifer_fill_hex="#FFFF00",
        map_lifer_edge_hex="#800080",
        last_seen_fill_hex="#90EE90",
        last_seen_edge_hex="#800080",
        emphasis_fill_opacity=MAP_PIN_FILL_OPACITY_EMPHASIS,
        map_lifer_fill_opacity=MAP_PIN_FILL_OPACITY_EMPHASIS,
    ),
    lifer_locations=MapMarkerLiferLocationsStyle(
        lifer_fill_hex="#FFFF00",
        lifer_edge_hex="#800080",
        subspecies_fill_hex="#FF0000",
        subspecies_edge_hex="#800080",
...
MAP_MARKER_COLOUR_SCHEME_3 = MapMarkerColourScheme(
    ...
    species_locations=MapMarkerSpeciesLocationsStyle(
        fill_hex="#B78FAF",
        edge_hex="#704868",
        map_lifer_fill_hex="#FCEC52",
        map_lifer_edge_hex="#566776",
        last_seen_fill_hex="#9EA93F",
        last_seen_edge_hex="#704868",
        emphasis_fill_opacity=0.9,
        map_lifer_fill_opacity=0.9,
        fill_opacity_override=0.9,
        map_lifer_fill_opacity_override=0.9,
    ),
    lifer_locations=MapMarkerLiferLocationsStyle(
        lifer_fill_hex="#FCEC52",
        lifer_edge_hex="#566776",
        subspecies_fill_hex="#B78FAF",
        subspecies_edge_hex="#704868",
