...
_MAP_MARKER_COLOUR_SCHEME_3_VALUES = dict(
    ...
    marker_cluster_inner_fill_opacity=0.75,
    marker_cluster_halo_opacity=0.45,
    marker_cluster_border_opacity=0.55,
    marker_cluster_halo_spread_px=3,
    marker_cluster_border_width_px=1,
)
