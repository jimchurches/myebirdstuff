...
def map_maintenance_intro_html() -> str:
  ...
  <div class="maint-html-blurb">
    ...
    <p>{caution_glyph}Update locations in eBird with caution. This data is provided here to help the author with particular use cases related to his own location data.</p>
  </div>"""
