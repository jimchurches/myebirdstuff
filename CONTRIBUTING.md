...
- **AI-assisted work** — If you use AI tools, follow **[docs/AI_CONTEXT.md](docs/AI_CONTEXT.md)** (AI Coding Rules and related sections) and **[docs/python-style-guide.md](docs/python-style-guide.md)** (Python style standard).
